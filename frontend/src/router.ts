...
const router: Router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      redirect: { name: 'SpaceOverview' },
      props: true,
      children: [
        {
          name: 'SpaceOverview',
          path: '',
          component: () => import('@/pages/SpaceOverview/SpaceOverview.vue'),
          props: true,
        },
        {
          name: 'SpaceCustomize',
          path: 'customize',
          component: () => import('@/pages/SpaceOverview/SpaceCustomize.vue'),
          props: true,
        },
        {
          name: 'SpaceDiscussions',
          path: 'discussions/:podId?',
